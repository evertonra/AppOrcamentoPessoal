...
function cadastrarDespesa() {
	...
	if(despesa.validarDados()){
		...
		document.getElementById('motal_titulo_div').className = 'modal-header text-success'
		...
		document.getElementById('motal_titulo_div').className = 'modal-header text-danger'
